...
public class Level4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.preview_img_four);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level4.this, GameLevels.class); // Создали намерение для перехода с 4 уровня в пункт меню выбора уровней
        ...
        btnclose2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    //Вернуться назад к выбору уровня - начало
                    Intent intent = new Intent(Level4.this, GameLevels.class); // Создали намерение для 4 с первого уровня в пункт меню выбора уровней
                    startActivity(intent);//Старт намерения
                    finish();//Закрыть этот класс
                    //Вернуться назад к выбору уровня - конец
                }catch (Exception e){
        ...
        img_left.setImageResource(array.imgest4[numLeft]); //Достаем из массива картинку
        ...
        img_right.setImageResource(array.imgest4[numRight]);//Достаем из массива картинку
