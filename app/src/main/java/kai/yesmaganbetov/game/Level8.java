...
public class Level8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.preview_img_8);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level8.this, GameLevels.class); // Создали намерение для перехода с 8 уровня в пункт меню выбора уровней
        ...
        btnclose2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    //Вернуться назад к выбору уровня - начало
                    Intent intent = new Intent(Level8.this, GameLevels.class); // Создали намерение для 8 с первого уровня в пункт меню выбора уровней
                    startActivity(intent);//Старт намерения
                    finish();//Закрыть этот класс
                    //Вернуться назад к выбору уровня - конец
                }catch (Exception e){
        ...
        numLeft = random.nextInt(10); //Генерируем случаеное число
        img_left.setImageResource(array.imgest8[numLeft]); //Достаем из массива картинку
        text_left.setText(array.text8[numLeft]); //Достаем из массива текст


        numRight = random.nextInt(10); //Генерируем случаеное число
        ...
        img_right.setImageResource(array.imgest8[numRight]);//Достаем из массива картинку
        text_right.setText(array.text8[numRight]); //Достаем из массива текст
