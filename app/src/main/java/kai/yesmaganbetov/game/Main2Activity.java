...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Main2Activity.this, GameLevels.class); // Создали намерение для перехода с первого уровня в пункт меню выбора уровней
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(Main2Activity.this, Level2.class);
        ...
        final Animation a = AnimationUtils.loadAnimation(Main2Activity.this, R.anim.alpha);
        //Подключаем анимацию - конец

        numLeft = random.nextInt(10); //Генерируем случаеное число от нуля до 9
        img_left.setImageResource(array.imgest1[numLeft]); //Достаем из массива картинку
        ...
        img_right.setImageResource(array.imgest1[numRight]);//Достаем из массива картинку
