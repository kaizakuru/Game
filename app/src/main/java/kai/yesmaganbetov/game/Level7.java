...
public class Level7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.preview_img_7);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level7.this, GameLevels.class); // Создали намерение для перехода с 7 уровня в пункт меню выбора уровней
        ...
        btnclose2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    //Вернуться назад к выбору уровня - начало
                    Intent intent = new Intent(Level7.this, GameLevels.class); // Создали намерение для 7 с первого уровня в пункт меню выбора уровней
                    startActivity(intent);//Старт намерения
                    finish();//Закрыть этот класс
                    //Вернуться назад к выбору уровня - конец
                }catch (Exception e){
        ...
        numLeft = random.nextInt(20); //Генерируем случаеное число
        img_left.setImageResource(array.imgest7[numLeft]); //Достаем из массива картинку
        text_left.setText(array.text7[numLeft]); //Достаем из массива текст


        numRight = random.nextInt(20); //Генерируем случаеное число

        //Цикл с предусловием проверяющий равенство чисел - начало
        while (array.strong1[numLeft]==array.strong1[numRight]){
            numRight = random.nextInt(20);
        }
        //Цикл с предусловием проверяющий равенство чисел - конец

        img_right.setImageResource(array.imgest7[numRight]);//Достаем из массива картинку
        text_right.setText(array.text7[numRight]); //Достаем из массива текст
        ...
        img_left.setOnTouchListener(new View.OnTouchListener() {
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    if (array.strong1[numLeft]>array.strong1[numRight]){
    ...
    public void onBackPressed (){
        ...
        try {
            //Вернуться назад к выбору уровня - начало
            Intent intent = new Intent(Level7.this, GameLevels.class); // Создали намерение для перехода с 4 уровня в пункт меню выбора уровней
            startActivity(intent);//Старт намерения
            finish();//Закрыть этот класс
            //Вернуться назад к выбору уровня - конец
        }catch (Exception e){
