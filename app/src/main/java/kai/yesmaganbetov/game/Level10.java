...
public class Level10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.preview_img_10);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level10.this, GameLevels.class); // Создали намерение для перехода с 10 уровня в пункт меню выбора уровней
        ...
        numLeft = random.nextInt(8); //Генерируем случаеное число от нуля до
        img_left.setImageResource(array.imgest10[numLeft]); //Достаем из массива картинку
        text_left.setText(array.text10[numLeft]); //Достаем из массива текст


        numRight = random.nextInt(8); //Генерируем случаеное число от нуля до 9
        ...
        img_right.setImageResource(array.imgest10[numRight]);//Достаем из массива картинку
        text_right.setText(array.text10[numRight]); //Достаем из массива текст
                ...
                if (event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    //Если отпустил палец - конец
                        if (count==20){
                            ...
                            numLeft = random.nextInt(8); //Генерируем случаеное число от нуля до 9
                            img_left.setImageResource(array.imgest10[numLeft]); //Достаем из массива картинку
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction()==MotionEvent.ACTION_DOWN){
                    ...
                    if (count==20){
                        ...
                        numRight = random.nextInt(8); //Генерируем случаеное число от нуля до
