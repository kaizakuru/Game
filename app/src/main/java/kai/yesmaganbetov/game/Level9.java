...
public class Level9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.preview_img_9);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level9.this, GameLevels.class); // Создали намерение для перехода с 9 уровня в пункт меню выбора уровней
        ...
        btnclose2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    //Вернуться назад к выбору уровня - начало
                    Intent intent = new Intent(Level9.this, GameLevels.class); // Создали намерение для 9 с первого уровня в пункт меню выбора уровней
                    startActivity(intent);//Старт намерения
                    finish();//Закрыть этот класс
                    //Вернуться назад к выбору уровня - конец
                }catch (Exception e){
        ...
        img_left.setImageResource(array.imgest9[numLeft]); //Достаем из массива картинку
        text_left.setText(array.text9[numLeft]); //Достаем из массива текст
        ...
        img_right.setImageResource(array.imgest9[numRight]);//Достаем из массива картинку
        text_right.setText(array.text9[numRight]); //Достаем из массива текст
