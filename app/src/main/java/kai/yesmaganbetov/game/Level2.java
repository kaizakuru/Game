...
public class Level2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level2.this, GameLevels.class); // Создали намерение для перехода с 2 уровня в пункт меню выбора уровней
        ...
        img_left.setImageResource(array.imgest2[numLeft]); //Достаем из массива картинку
        ...
        img_right.setImageResource(array.imgest2[numRight]);//Достаем из массива картинку
