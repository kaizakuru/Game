...
public class Level6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.preview_img_6);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Intent intent = new Intent(Level6.this, GameLevels.class); // Создали намерение для перехода с 6 уровня в пункт меню выбора уровней
        ...
        btnclose2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    //Вернуться назад к выбору уровня - начало
                    Intent intent = new Intent(Level6.this, GameLevels.class); // Создали намерение для 6 с первого уровня в пункт меню выбора уровней
                    startActivity(intent);//Старт намерения
                    finish();//Закрыть этот класс
                    //Вернуться назад к выбору уровня - конец
                }catch (Exception e){
        ...
        numLeft = random.nextInt(6); //Генерируем случаеное число от нуля до 9
        img_left.setImageResource(array.imgest6[numLeft]); //Достаем из массива картинку
        text_left.setText(array.text6[numLeft]); //Достаем из массива текст


        numRight = random.nextInt(6); //Генерируем случаеное число от нуля до 9
        ...
        img_right.setImageResource(array.imgest6[numRight]);//Достаем из массива картинку
        text_right.setText(array.text6[numRight]); //Достаем из массива текст
